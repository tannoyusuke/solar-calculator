...
export default function PersonaClient({ dict }: { dict: any }) {
    return (
        <div className="pt-32 pb-24 min-h-screen bg-background relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
                ...
                >
                    ...
                    <h1
                        className="text-4xl md:text-6xl font-sans font-bold tracking-tight mb-8 text-white"
            ...
            {/* Embedded Components */}
            <RecruitPersona dict={dict.mindset} />
            <RecruitSystem dict={dict.system} />
        </div>
    );
}
