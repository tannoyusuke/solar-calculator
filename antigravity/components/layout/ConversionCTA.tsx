            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 w-full">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
                    ...
                    <ScrollReveal delay={0.1} direction="left" className="h-full">
                        <div className="p-10 md:p-16 border border-white/10 relative overflow-hidden group bg-white/[0.02] h-full">
                            {/* Glow effect */}
                    ...
                    <ScrollReveal delay={0.3} direction="right" className="h-full">
                        <div className="p-10 md:p-16 border border-white/20 relative overflow-hidden group bg-white h-full">
